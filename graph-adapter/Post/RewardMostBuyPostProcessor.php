...
class RewardMostBuyPostProcessor extends RecommendationSetPostProcessor
{

    public function name(): string
    {
        return "reward_most_buy";
    }
    ...
    public function buildQuery(Node $input, Recommendations $recommendations): Statement
    {
        ...
        RETURN id(product) as id, product.sell as score';
    ...
    {
        $recommendation->addScore($this->name(), new SingleScore($record->get('score'), 'most_buy'));
    }
}